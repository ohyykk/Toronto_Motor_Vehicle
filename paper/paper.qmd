...
#| fig-cap: "10 Examples of Neighborhood Incidents Count"
#| echo: false
#| warning: false
#| message: false
...
The **Traffic Control** variable categorizes the type of traffic management present at the site of each incident, such as "No Control," "Traffic Signal," or "Stop Sign." This variable provides insight into how various traffic control measures influence the likelihood of motorbike collisions.
...
#| fig-cap: "Summary of Traffic Control"
#| echo: false
#| warning: false
#| message: false
...
#| fig-cap: "5 Examples of Different Times of Day with Incident Count"
#| echo: false
#| warning: false
#| message: false
...
@plot-visibility_summary summarizes the distribution of collisions across different visibility conditions, revealing that the vast majority of incidents occur during clear conditions. This is likely due to the overall higher frequency of clear weather compared to adverse conditions. Rain accounts for the second-highest number of incidents, while other conditions, such as snow, fog, and strong winds, contribute to a much smaller share of collisions. 

```{r}
#| label: plot-visibility_summary
...
This study highlights significant temporal variations in motorbike theft and collision risks, revealing clear patterns that can inform both behavioral changes and policy interventions. The analysis shows that theft incidents peak during late-night hours, particularly between [specific time range], when surveillance and public activity are minimal. Similarly, collision risks are concentrated during [specific time range], corresponding to high-traffic periods such as morning and evening rush hours. These findings underscore the importance of time-sensitive strategies to mitigate risks.

### Behavioral Recommendations for Motorbike Owners
Motorbike owners can adopt several precautionary measures based on the identified temporal risk patterns, including avoiding high-risk hours, enhancing security measures, and having defensive driving practices. Restricting motorbike use during late-night hours or parking in secure locations equipped with surveillance can significantly reduce theft exposure; utilizing anti-theft devices, such as GPS trackers or motion-sensitive alarms, can deter theft, particularly during vulnerable time periods; exercising heightened caution during peak traffic hours, adhering to speed limits and maintaining safe distances can minimize the collision risks.

### Policy Recommendations for Stakeholders
Policymakers and law enforcement agencies can leverage several insights to develop targeted interventions. First is to have time-sensitive patrol scheduling by increasing law enforcement presence during high-theft hours to act as a deterrent and ensure faster response times. One can also develop traffic monitoring during rush hours such as surveillance cameras and traffic officers to help manage congestion and reduce collision risks. Another idea could be to have public awareness campaigns and educational initiatives to inform motorbike owners about high-risk times and promote safety practices tailored to temporal risk patterns.

## Environmental and Situational Influences on Risk

Environmental and situational factors significantly influence the Risk Index, highlighting their role in motorbike thefts and collisions. This study identified critical predictors, such as road surface conditions, lighting environments, and traffic control mechanisms, which collectively shape risk levels. Poor road conditions, inadequate lighting, and the absence of traffic control systems emerge as key contributors to heightened risks.

Wet or icy road surfaces significantly increase collision risks, likely due to reduced traction and longer braking distances. Dry roads, while more common, are not risk-free and often correlate with higher traffic volumes. Low-light conditions, especially at night and under artificial lighting, exacerbate risks due to reduced visibility and delayed reaction times. While daylight offers better visibility, high traffic density during daytime hours can still elevate risk levels. The absence of traffic controls, such as stop signs or traffic signals, is associated with higher incident rates, underscoring their importance in mitigating risks.
